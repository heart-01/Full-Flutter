...
class CallApi {
  ...
  //API อ่านข่าวล่าสุด
  //Future คือ  รูปแบบการีเทิร์นข้อมูลที่มีการรอคอยว่าข้อมูลที่ตอบกลับมาคืออะไร เป็น async function Future จะเป็นตัวที่ภาษา dart เตรียมข้อมูลมาให้ใช้ร่วมกับ Future builder flutter
